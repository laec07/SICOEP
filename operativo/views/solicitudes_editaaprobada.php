            ...
            <div style='overflow:scroll;height: 100% '>
              <table id='example2' class='table table-bordered table-striped'>
                ...
                while ($fila=mysqli_fetch_array($ruta)) {
                  ...
                  $b=$fila['asignado_gal'];
                  $c=$b/2;
                 //calcula color a mostrar segun porcentaje
                  if ($a > $c) {
                  ...
                  /****************************/
                  if ($fila['extra_gal']=='S') {//muestra modal galones extras
                    $clase_2="class='danger' title='Galones adicionales'";
                  ...
                  if ($fila['total']>0) {
                  	$boton_remover="<a class='btn btn-danger' title='Quitar ruta'
