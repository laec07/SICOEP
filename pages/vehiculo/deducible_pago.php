      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="rutas-reporte.php"><i class="fa fa-line-chart"></i>Reportes</a></li>
          </ul>
        </li>
        <!--Pago deducible-->
        <li><a href="deducible_pago.php"><i class="fa fa-motorcycle"></i><span>Deducible</span></a></li>
        <!--Movimiento diario-->
...
<script src="../../controllers/deducible.js"></script>
