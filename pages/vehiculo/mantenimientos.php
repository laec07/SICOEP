...
$año_actual= date("Y");
/************************************************************************************************************/
$busca_pres_vehi=mysqli_query($conexion,"SELECT monto FROM mantenimiento_vehiculo_presupuesto where codigo_pais='$pais' and MONTH(fecha)='$mes_actual'");
$r_pres=mysqli_fetch_array($busca_pres_vehi);
$monto_pres=$r_pres['monto'];
/**********************************************************************************************************/ 
////////////////////////////
      ...
      <div class="row">
        ...
        <div class="col-md-3">
              <div class="alert alert-info alert-dismissible row">
                <div class="col-md-8">
                  <h4>Presupuesto: <?php echo $rps['moneda']. number_format($monto_pres,2,'.',','); ?></h4>
                </div>
                <div class="col-md-4">
                  <button class="btn btn-info btn-block" data-target="#Presupuesto_mante" data-toggle='modal'><span class="fa fa-pencil"></span></button>
                </div>
        ...
        <div class="col-md-3">
          <div class="alert alert-info alert-dismissible">
                ...
                <h4>Acumulado mes <?php echo $rps['moneda']. number_format($rtotal['costo'],2,'.',','); ?></h4>
                
              </div>
 
        </div>
         <div class="col-md-4">
          <a href="" class="btn btn-info" data-target="#nuevoMante" data-toggle='modal' title="Nueva ingreso"><i class="fa fa-plus"></i> Agregar</a>
          <a href="" class="btn btn-primary" data-target="#Historial" data-toggle='modal' title="Historial"><i class="fa fa-search"></i> Buscar</a>
           <a href="mantenimientos_alertas.php" class="btn btn-warning"  title="Configurar alertas mantenimiento"><i class="fa  fa-bell"></i> Alertas</a>
        </div>
      </div>
    </section>
    <!-- Main content -->
    <section class="content container-fluid">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Bitácora</h3><small> mes actual</small>
           <a href="mantenimientos_excel.php" class="btn btn-success pull-right"><i class="fa fa-file-excel-o"></i></a>
          </div>
          <div class="box-body">
        ...
        <div class="box box-default collapsed-box"><!--inicia body tipo-->
            <div class="box-header whith-border">
                <h3 class="box-title">Gasto por tipo:</h3> <small> Mes actual</small>

                <div class="box-tools pull-right">
                  <a href="mante_tipo_excel.php" class="btn btn-success "><i class="fa fa-file-excel-o"></i></a>
        ...
        <div class="row"><!--inicia gráficas-->
          <div class="col-md-6"><!--inicia área gráfica -->
            <div class="box box-primary">
              <div class="box-header whith-border">
                <h3 class="box-title">Gasto año actual</h3>
                <div class="box-tools pull-right">
...
<!-- -------------------------------------------------------------- -->
   <div class="modal modal-default fade" id="Historial">
              ...
              <div class="modal-body">
                <form action="mantenimientos_busqueda.php" method="POST" >
                  ...
                  <div class="row"> 
                    <div class="col-md-4">
                        <label>Del:</label>
                        <input type="date" name="inicio" id="inicio" class="form-control" value="<?php echo Date("Y-m-d")?>" >
                        
                    </div>
                    <div class="col-md-4">
                      <label>Al:</label>
                      <input type="date" name="fin" id="fin" class="form-control" value="<?php echo Date("Y-m-d")?>" >
                    </div>
                    <div class="col-md-4">
                      <label>Tipo mantenimiento:</label>
                      <select name="tipo" class="form-control">
      ...
      <!-- *************./Presupuesto******************** -->
   <div class="modal modal-default fade" id="Presupuesto_mante">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              ...
              <div class="modal-body">
                <form action="../../consultas/mante_vehi_presupuesto.php" method="POST" >

                    <div class="form-group">
                      <label>Monto</label>
                      <input class="form-control" type="number" name="monto_presupuesto" id="monto_presupuesto" step="0.01" placeholder="0.00">
                    </div>
...
<!-- DataTables -->
<script src="../../bower_components/datatables.net/js/jquery.dataTables.min_cliente.js"></script>
