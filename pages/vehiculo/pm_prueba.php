...
<div class="wrapper">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active" ><a href="pm_prueba.php"><i class="fa  fa-file-text"></i>Prueba</a></li>
  ...
  <div class="content-wrapper">
    ...
    <div class="box box-danger">
      <div class="box-head">
        <h3>
          Seleccione Aspirante a evaluar  
        </h3>
      </div>
      <div class="box-body">
        <div class="row">
          <div class="col-md-6">
            <div class="from-group">
              ...
              <select class="form-control" id="id_usuario" >
                <option >Seleccionar aspirante</option>

                <?php
                while ($fila_a=mysqli_fetch_array($aspirante)) {
                  echo "
                   <option value='".$fila_a['Id_usuario']."'>".$fila_a['Usuario']."</option> 
                  ";
                }
          ...
          <div class="col-md-2">
            <label></label>
            <button class="btn btn-primary btn-block" onclick="insert_data()" >Iniciar</button>
          </div>
        </div>
      </div>
    </div>
...
<!-- Acciones bd -->
<script src="../../controllers/pm_prueba.js"></script>
