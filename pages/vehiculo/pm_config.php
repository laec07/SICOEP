...
$año_actual= date("Y");
/*************************************************/
$criterio=mysqli_query($conexion,"
SELECT
  *
FROM
  pm_criterio
WHERE
  ...
  ");
/***************************************************/
$tipo_preg=mysqli_query($conexion,"
SELECT
  *
FROM
  pm_tipopregunta
WHERE
  ...
  ");
/*************************************************/
$criterio2=mysqli_query($conexion,"
SELECT
  *
FROM
  pm_criterio
WHERE
  ...
  ");
/***************************************************/
$tipo_preg2=mysqli_query($conexion,"
SELECT
  *
FROM
  pm_tipopregunta
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="pm_config.php"><i class="fa  fa-gears"></i>Configuración</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>Configuración Prueba Manejo (pm)</small>
      </h1>
      <!-- <ol class="breadcrumb">
    ...
    <section class="content container-fluid">
      ...
      <!--------------------------
        ...
        -------------------------->
        <div id="cont_header"></div>
        <div id="cont_body"></div>
        
<!--       modales                 -->

      <!-- Editar criterios -->
      <div class="modal fade" id="edita_criterio" >
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
             <form action="" method="POST">
                <input type="hidden" name="di_criterio" id="id_criterio">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="edita_criterio();">Guardar</button>
      ...
      <!-- Ingresar pregunta -->
      <div class="modal fade" id="Addquest" >
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
             <form action="" method="POST">
                ...
                <div class="form-group">
                 ...
                 <select id="ins_criterio" class="form-control">
                  <?php
                  while ($fila_cr=mysqli_fetch_array($criterio)) {
                    echo "
                    <option value='".$fila_cr['id_criterio']."'>".$fila_cr['descripcion']." </option> 
                    ";
                  }
                  ?> 
                 </select>
               ...
               <div class="form-group">
                 ...
                 <select id="ins_tipo_pregunta" class="form-control">
                  <?php
                  while ($fila_tp=mysqli_fetch_array($tipo_preg)) {
                    echo "
                    <option value='".$fila_tp['id_tipopregunta']."'>".$fila_tp['descripcion']." </option> 
                    ";
                  }
                  ?>                    
                 </select>
               ...
               <div class="form-group">
                 <label>Titulo</label>
                 <input type="text" class="form-control" name="ins_titulo" id="ins_titulo" maxlength="50">
               </div>

               <div class="form-group">
                 <label>Descripción</label>
                 <input type="text" class="form-control" name="ins_descripcion" id="ins_descripcion" maxlength="100">
               </div>

             </form> 
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="insert_quest();">Guardar</button>
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
            </div>
          </div>
        </div>
      ...
      <!-- Editar pregunta -->
      <div class="modal fade" id="Editquest" >
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
             ...
             <form action="" method="POST">
                <div class="form-group">
                  <label>ID</label>
                  <input type="text" name="id_qkluest" id="id_quest" readonly="" class="form-control" >
                </div>
                <div class="form-group">
                 <label>Categoría</label>
                 <select id="edit_criterio" class="form-control">
                  <?php
                  while ($fila_cr=mysqli_fetch_array($criterio2)) {
                    echo "
                    <option value='".$fila_cr['id_criterio']."'>".$fila_cr['descripcion']." </option> 
                    ";
                  }
               ...
               <div class="form-group">
                 <label>Tipo pregunta</label>
                 <select id="edit_tipo_pregunta" class="form-control">
                  <?php
                  while ($fila_tp=mysqli_fetch_array($tipo_preg2)) {
                    echo "
                    <option value='".$fila_tp['id_tipopregunta']."'>".$fila_tp['descripcion']." </option> 
                    ";
                  }
               ...
               <div class="form-group">
                 <label>Titulo</label>
                 <input type="text" class="form-control" name="edit_titulo" id="edit_titulo" maxlength="50">
               </div>

               <div class="form-group">
                 <label>Descripción</label>
                 <input type="text" class="form-control" name="edit_descripcion" id="edit_descripcion" maxlength="100">
               </div>

                <div class="form-group">
                 <label>Categoría</label>
                 <select id="edit_estatus" class="form-control">
                  <option value="A">Activo</option>
                  <option value="I">Inactivo</option> 
                 </select>
                </div>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="edit_quest();">Guardar</button>
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
            </div>
          </div>
        </div>
...
<!-- Controllers -->
<script src="../../controllers/pm_config.js"></script>
