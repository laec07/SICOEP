  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="vehiculo.php"><i class="fa fa-table"></i><span>Tareas</span></a></li>
        <li><a href="pilotos.php"><i class="fa fa-desktop"></i><span>Equipo</span></a></li>
     <li><a href="asignaciones.php"><i class="fa fa-edit"></i><span>Asignaciones</span></a></li>
        ...
        <li><a href="mantenimientos.php"><i class="fa  fa-file-text"></i><span>Documentar problemas</span></a></li>
        <!--
        <li class="treeview">
          <a href="#">
